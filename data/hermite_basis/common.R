...
library(pracma)
library(fda.usc)
source('hermite_basis/basisfd.R')
source('hermite_basis/create.hermite.basis.R')
source('hermite_basis/hermite.R')
source('hermite_basis/getbasismat.R')
source('hermite_basis/hermitepen.R')
source('hermite_basis/eval.penalty.R')
source('hermite_basis/smooth.monotone.R')
